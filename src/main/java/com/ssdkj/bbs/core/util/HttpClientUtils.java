...
public class HttpClientUtils {
    ...
    static {
        ...
        config = RequestConfig.custom().setConnectTimeout(100) // 创建连接的最长时间
     ...
     */
    @Deprecated
    public static String doPostXml(String url, String xmlData) throws Exception {
        // 从连接池获取HttpClient
        CloseableHttpClient httpClient = getHttpClient();
        // 声明http的post请求
        HttpPost httpPost = new HttpPost(url);
     ...
     * @throws
     */
    public static String doPostXml2(String url, String xmlData) throws Exception {
        // 从连接池获取HttpClient
        CloseableHttpClient httpClient = getHttpClient();
        // 声明http的post请求
        HttpPost httpPost = new HttpPost(url);
    ...
    // GetBillDetailParams params = new GetBillDetailParams();
    // params.setAppKey("9dc6722555914cb5");
    // params.setMethod("coo8.shop.billdetail.get");
    // params.setTimestamp(DateUtils.formatDateTime(new Date()));
    // params.setV("2.0");
    // params.setVenderId("80000732");
    // params.setSignMethod("md5");
    // params.setBillId("201603000017");
    // Map<String, Object> map = BeanMapUtils.convertBean(params);
    // params.setSign(MD5Utils.convertMD5(map, params.getAppKey()));
    // map.put("sign", params.getSign());
    // String result = HttpClientUtils.doPost("http://open.coo8.com/ApiControl", map);
